...
exports.store_save_product = (_req, _res) => {
    if (typeof _req.files.productimage2 === "undefined" && typeof _req.files.productimage3 === "undefined") {
        ...
        const url1 = "https://hotelyahaytest.herokuapp.com/images/hotelimages/storeimages/" + datetime + "first.png";
        ...
        const url1 = "https://hotelyahaytest.herokuapp.com/images/hotelimages/storeimages/" + datetime + "first.png";
        const url2 = "https://hotelyahaytest.herokuapp.com/images/hotelimages/storeimages/" + datetime + "second.png";
        fs.rename(tempPath1, targetPath1, _err1 => {
            if (!_err1) {
        ...
        const url1 = "https://hotelyahaytest.herokuapp.com/images/hotelimages/storeimages/" + datetime + "first.png";
        const url3 = "https://hotelyahaytest.herokuapp.com/images/hotelimages/storeimages/" + datetime + "third.png";
        fs.rename(tempPath1, targetPath1, _err1 => {
            if (!_err1) {
...
exports.store_update_profile = (_req, _res) => {
    if (typeof _req.file === "undefined") {
        ...
        const url = "https://hotelyahaytest.herokuapp.com/images/hotelimages/storeimages/" + datetime + ".png";
...
exports.store_update_product = (_req, _res) => {
    ...
    const url1 = typeof _req.files.updateimage === "undefined" ? "" : ("https://hotelyahaytest.herokuapp.com/images/hotelimages/storeimages/" + datetime + "first.png");
    const url2 = typeof _req.files.updateimage2 === "undefined" ? "" : ("https://hotelyahaytest.herokuapp.com/images/hotelimages/storeimages/" + datetime + "second.png");
    const url3 = typeof _req.files.updateimage3 === "undefined" ? "" : ("https://hotelyahaytest.herokuapp.com/images/hotelimages/storeimages/" + datetime + "third.png");
...
exports.store_verify_now = (_req, _res) => {
    const dest = path.join(__dirname, '../public/images/hotelimages/verification/');
    ...
    const url1 = "https://hotelyahaytest.herokuapp.com/images/hotelimages/verification/" + datetime + "typeone.png";
    const url2 = "https://hotelyahaytest.herokuapp.com/images/hotelimages/verification/" + datetime + "typetwo.png";
    fs.rename(tempPath1, targetPath1, _err1 => {
        if (!_err1) {
            fs.rename(tempPath2, targetPath2, _err2 => {
                if (!_err2) {
